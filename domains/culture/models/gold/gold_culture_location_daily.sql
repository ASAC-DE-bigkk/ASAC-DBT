...
--   공연을 공연목록·축제목록에 함께 실어(mt20id 공유) kopis_festivals_count 가 performances_count
...
select
    ...
    count(distinct case when type_bucket = 'festival'    then activity_id end) as kopis_festivals_count,
